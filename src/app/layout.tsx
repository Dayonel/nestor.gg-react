...
const sourceSans3 = Source_Sans_3({ subsets: ["latin"], weight: "700" });
export const metadata: Metadata = {
  title: "Nestor Plysyuk - Full stack developer",
  description:
    "Explore Amsterdam's stunning architecture through a unique portfolio experiment, built using Three.js and Svelte, integrating multiple scenes on a single page.",
};
  ...
  return (
    <html lang="en">
      <Head>
        ...
        <meta
          property="og:title"
          content="Nestor Plysyuk - Full stack developer"
        />
        ...
        <meta
          ...
          content="Nestor Plysyuk portfolio experiment Amsterdam architecture scene."
        />

        {/* Non-Essential, But Required for Analytics  */}
        <meta name="twitter:site" content="@nestordotgg"></meta>
      </Head>
      <body
        className={`${handjet.className} ${roboto.className} ${sourceSans3.className} antialiased`}
      >
